...
/** not-@type {!BigUint64Array} */
  ...
  function findWasmBinary() {
    if (Module.locateFile) {
      return locateFile('fun.wasm')
    }
    // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
    return new URL('fun.wasm', import.meta.url).href
  }
  ...
  const FS_writeFile = (...args) => FS.writeFile(...args)

  const FS_readFile = (...args) => FS.readFile(...args)
  ...
  let _wasm_convert_to_pngs = Module._wasm_convert_to_pngs = makeInvalidEarlyAccess('_wasm_convert_to_pngs')
  let _wasm_convert_to_icns = Module._wasm_convert_to_icns = makeInvalidEarlyAccess('_wasm_convert_to_icns')
  let _wasm_convert_to_ico = Module._wasm_convert_to_ico = makeInvalidEarlyAccess('_wasm_convert_to_ico')
  let _wasm_convert_to_both = Module._wasm_convert_to_both = makeInvalidEarlyAccess('_wasm_convert_to_both')
  var _fflush = makeInvalidEarlyAccess('_fflush')
  var _emscripten_stack_get_end = makeInvalidEarlyAccess('_emscripten_stack_get_end')
  let _emscripten_stack_get_base = makeInvalidEarlyAccess('_emscripten_stack_get_base')
  var _strerror = makeInvalidEarlyAccess('_strerror')
  let _emscripten_stack_init = makeInvalidEarlyAccess('_emscripten_stack_init')
  let _emscripten_stack_get_free = makeInvalidEarlyAccess('_emscripten_stack_get_free')
  var __emscripten_stack_restore = makeInvalidEarlyAccess('__emscripten_stack_restore')
  var __emscripten_stack_alloc = makeInvalidEarlyAccess('__emscripten_stack_alloc')
  var _emscripten_stack_get_current = makeInvalidEarlyAccess('_emscripten_stack_get_current')

  function assignWasmExports(wasmExports) {
    Module._wasm_convert_to_pngs = _wasm_convert_to_pngs = createExportWrapper('wasm_convert_to_pngs', 1)
    Module._wasm_convert_to_icns = _wasm_convert_to_icns = createExportWrapper('wasm_convert_to_icns', 2)
    Module._wasm_convert_to_ico = _wasm_convert_to_ico = createExportWrapper('wasm_convert_to_ico', 2)
    Module._wasm_convert_to_both = _wasm_convert_to_both = createExportWrapper('wasm_convert_to_both', 2)
