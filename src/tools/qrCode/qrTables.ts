...
// EC_BLOCK[version][ecLevel] = [ecPerBlock, g1Blocks, g1DataCW, g2Blocks, g2DataCW]
export const EC_BLOCK: number[][][] = [
  [],
...
/** Total codewords (data + EC) for a version — same across all EC levels. */
export function getTotalCodewords(version: number): number {
  const [ecPerBlock, g1Blocks, g1DataCW, g2Blocks, g2DataCW] = EC_BLOCK[version][0]
  const dataCW = g1Blocks * g1DataCW + g2Blocks * g2DataCW
  return dataCW + ecPerBlock * (g1Blocks + g2Blocks)
}
